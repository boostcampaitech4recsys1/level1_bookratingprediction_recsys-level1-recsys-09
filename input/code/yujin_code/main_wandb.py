...
if __name__ == "__main__":
    ...
    # arg('--NCF_MLP_DIMS', type=int, default= (16,16), nargs='+', help='NCF에서 MLP Network의 차원을 조정할 수 있습니다.')
    arg('--NCF_MLP_DIMS_0', type=int, default= 16, help='NCF에서 MLP Network의 차원을 조정할 수 있습니다.')
    arg('--NCF_MLP_DIMS_1', type=int, default= 16, help='NCF에서 MLP Network의 차원을 조정할 수 있습니다.')
    ...
    arg('--WDN_MLP_DIMS_0', type=int, default= 16, help='NCF에서 MLP Network의 차원을 조정할 수 있습니다.')
    arg('--WDN_MLP_DIMS_1', type=int, default= 16, help='NCF에서 MLP Network의 차원을 조정할 수 있습니다.')
    ...
    arg('--DCN_MLP_DIMS_0', type=int, default=16, help='DCN에서 MLP Network의 차원을 조정할 수 있습니다.')
    arg('--DCN_MLP_DIMS_1', type=int, default=16, help='DCN에서 MLP Network의 차원을 조정할 수 있습니다.')
    ...
    arg('--WANDB', type=bool, default=True, help='WANDB에 기록 여부를 조정할 수 있습니다.')
    ...
    config = wandb.config
    wandb.run.name = "model: {0}".format(config['MODEL'])
    wandb.run.save()
